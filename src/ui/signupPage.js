...
import { Card, Container, Row, Form, Col, Alert } from "react-bootstrap";
                ...
                <col md={6}>
                    <Card>
                        <Card.body>
                            ...
                            {/*
                                !!연산자를 어떠한 값을 강제로 boolean 형태로 변환해주는 자바스크립트 기법입니다.
                            ...
                            */}
                            ...
                            <Form onSubmit={SignupAction}></Form>
