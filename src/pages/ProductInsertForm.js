...
function App() {
    ...
    const ControlChange = (event) => {
        //event 객체는 change 이벤트를 발생시킨 폼컨트롤입니다.
        const { name, value } = event.target;
        console.log(`값이 바뀐 컨트롤 : ${name}, 값 : ${value}`);

        //전재 연산자를 사용하여 이전 컨트롤의 값들도 보존하도록 합니다.
    ...
    return (
        <Container>
            ...
            <Form onSubmit={{ SubmitAction }}>
                ...
                {/* 이미지는 type="file"이어야 하고, 이벤트 처리 함수를 별개로 따로만들도록 합니다.*/}
                <Form.Group className="mb-3">
